			...
			<div ng-controller="cartCtrl" ng-init="initCartId('${cartId }')">
				...
				<table class="table table-hover">
					...
					<tr ng-repeat="item in cart.cartItems">
						...
						<td>
							<a class="btn-xs btn-danger" ng-click="removeFromCart(item.product.id)"> 
								<i class="fa fa-remove"></i>remove
							</a>
							<a class="btn-xs btn-danger" ng-click="addToCart(item.product.id)"> 
								<i class="fa fa-plus"></i>plus
							</a>
							<a class="btn-xs btn-danger" ng-click="minusToCartItemQuantity(item.product.id)"> 
